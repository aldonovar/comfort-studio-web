...
// CORRECCIÓN CLAVE: Usamos Default Imports (sin llaves) para todos los componentes para coincidir con sus archivos (export default)
  ...
  return (
    <div className="page">
      <main>
          ...
          {/* Si quieres usar el componente ScrollShowcase, descomenta la siguiente línea y asegúrate de que el archivo ScrollShowcase.tsx exista y use export default */}
          {/* <ScrollShowcase /> */}
