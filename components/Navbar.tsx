  ...
  return (
    <>
      ...
      >
        ...
        {/* Footer del Menú con Redes Sociales Reales */}
        <div
        ...
        >
          <div className="flex gap-6">
            <a href="https://www.instagram.com/comfortstudiop/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Instagram</a>
            <a href="https://www.facebook.com/comfortstudioperu" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Facebook</a>
            <a href="https://www.tiktok.com/@comfortstudio7" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">TikTok</a>
          </div>
          <div>Lima, Perú</div>
        </div>
      </div>
