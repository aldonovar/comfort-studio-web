...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Crear el mensaje para WhatsApp automáticamente
    ...
    // Redirigir a WhatsApp (Reemplaza el número por el real del cliente)
      ...
      <div className="container-safe" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'center' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div>
              <h4 style={{ fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '0.5rem' }}>Horario de Atención</h4>
              <p style={{ color: '#555' }}>Lunes a Viernes: 9:00 am - 6:00 pm</p>
            </div>
            <div>
              <h4 style={{ fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '0.5rem' }}>Contacto Directo</h4>
              <p style={{ color: '#555' }}>+51 999 999 999</p>
              <p style={{ color: '#555' }}>contacto@comfortstudioperu.com</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          padding: '3rem', 
          borderRadius: '4px', // Bordes sutiles
          boxShadow: '0 20px 40px rgba(176, 115, 87, 0.1)' // Sombra suave color terracota
        }}>
